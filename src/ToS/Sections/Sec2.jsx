...
const Sec2 = forwardRef(({sectionRefs},ref) => {
    return <>
        ...
        <div>
            ...
            written permission. With exception to the custom contents users create within their own projects, which the user may 
            share, display, and distribute of their own discretion both personally and commercially.
        </div>

        <div>
            If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our 
            Legal Terms, please address your request to: weavelcrochet@gmail.com. If we ever grant you the permission to post, 
            reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the 
        ...
        <div>
            Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms and our right to 
        ...
        <div>
            ...
            Submission. You agree that we shall own this Submission and be entitled to its unrestricted use and dissemination for any 
            lawful purpose, commercial or otherwise, without acknowledgement or compensation to you.
        </div>
