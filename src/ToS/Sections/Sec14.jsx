...
const Sec14 = forwardRef((_,ref) => {
    return <>
        <h2 ref = {ref}>14. Modifications and Interruptions</h2>
        ...
        <div>
            ...
            your inability to access or use the Services during any downtime or discontinuance of the Services. Nothing in these Legal
             Terms will be construed to obligate us to maintain and support the Services or to supply any corrections, updates, or 
