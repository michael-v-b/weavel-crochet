...
const Sec16 = forwardRef((_,ref) => {
    return <>
        <h2 ref = {ref}>16. Dispute Resolution</h2>

        <h3>Informal Negotiations</h3>

        <div>To expedite resolution and control the cost of any dispute, controversy, or claim related to these Legal Terms (each a 
        ...
        <div>
            ...
            the AAA’s Supplementary Procedures for Consumer Arbitration Rules (“AAA Consumer Rules”), both of which are available at 
            the American Arbitration Association (AAA) website. Your arbitration fees and your share of arbitrator compensation shall 
            be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. The arbitration may be 
            ...
            applicable AAA rules or applicable law, the arbitration will take place in the United States, New Jersey. Except as 
            otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, 
        ...
        <div>
            ...
            the state and federal courts located in UnitedStates, New Jersey, and the Parties hereby consent to, and waive all 
            defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state 
            and federal courts. Application of the United Nations Convention of Contracts for the International Sale of Goods and the 
        ...
        <div>
            ...
            elect to arbitrate any Dispute falling within that portion of this provision found to be illegal unenforceable and such 
            Dispute shall be decided by a court or competent jurisdiction within the courts listed for jurisdiction above, and the 
            Parties agree to submit to the personal jurisdiction of that court.
        </div>

        <h3>Restrictions</h3>

        <div>The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full 
        ...
        <div>
            ...
            or unauthorized use; and (c) any claim or injunctive relief. If this provision is found to be illegal or unenforceable, 
            then neither Party will elect to arbitrate any Dispute failing within that portion of this provision found to be illegal or 
