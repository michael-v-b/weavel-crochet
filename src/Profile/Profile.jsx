        ...
        <div className="projects-container">
          ...
          <div className="profile-option-container">
            ...
            <div className="profile-option-subcontainer">
              <div className="profile-option-title">Password Reset:</div>
            ...
            {/*DELETE ACCOUNT /////////////////////////*/}
            <div className="profile-option-subcontainer">
              <div className="profile-option-title">Delete Account:</div>
              <div className="profile-description">
                Clicking this will delete your account. It will delete all of
                your projects, and remove your email from our database.
              </div>
              <motion.div
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
