...
const Intro = () => {
    return <div>
        ...
        <div>
            This Privacy Notice for Weavel Crochet ("we","us", or "our"), describes how and why we might access, 
            collect, store, use, and/or share ("process") 
            your personal information when you use our services ("Services"), including when you:
        </div>

        <ul>
            <li>Visit our website at weavelcrochet.com or any website of ours that links to this Privacy Notice</li>
            <li>Engage with us in other related ways, including any sales, marketing, or events</li>
        </ul>

        <h3>Questions or concerns?</h3> 
        Reading this Privacy Notice will help you understand your privacy rights and choices. we are responsible for making decisions 
        about how your personal information is processed. If you do not agree with our policies and practices, please do not use our 
        Services. If you still have any questions or concerns, please contact us at weavelcrochet@gmail.com.
        ...
        <div>
            ...
            by clicking the link following each key point or by using our <span className=  "link">table of contents</span> below to 
        ...
        <div>
            ...
            features you use. Learn more about <span className = "link">personal information you disclose to us.</span>
            
        </div>

        <div>
            <strong>Do we process any sensitive personal information?</strong> 
            Some of the information may be considered "special" or"sensitive" in certain jurisdictions, for example your racial or 
        ...
        <div>
            ...
            We process our information to provide, improve, and administer our Services, communicate with you, for security and 
            fraud prevention, and to comply with law. We may also process your information for other purposes with our consent. 
            We process your information only when we have a valid legal reason to do so. Learn more about 
            <span className = "link">how we process your information</span>
        </div>
        ...
        <div>
            ...
            <span className= "link">when and with whom we share your personal information.</span>
        </div>

        <div>
            <strong>How do we keep our information safe?</strong> 
            We have adequate organization and technical processes and procedures in place to protect your personal information. 
            ...
            <span className = "link">HOW WE KEEP YOUR INFORMATION SAFE.</span>
        </div>
        ...
        <div>
            ...
            our personal information. Learn more about <span className = "link">YOUR PRIVACY RIGHTS.</span>
        </div>

        <div>
            <strong>How do you exercise your rights</strong> 
            The easiest way to exercise your rights is by contacting us at weavelcrochet@gmail.com. We will consider and act upon any 
