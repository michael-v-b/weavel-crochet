    ...
    return <>
       <h2>5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES</h2>
        ...
        <div>
            ...
            abandoned shopping cart reminders (depending on your communication preferences). The third parties and services tailored 
        ...
        <div>
            ...
            as defined underthe applicable laws) under applicable US state laws, you can opt out of these online tracking technologies 
            by submitting a request as described below under section 
            <span className = "link">"DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?"</span>
        </div>
        <div>
        ...
        <div>
            We may share your information with Google analytics to track and analyze the use of the Services. The Google Advertising 
            Features that we may use include :Google Analytics Demographics and Interests Reporting. To opt out of being tracked by 
            Google Analytics across the Services, visit <span className="link">https://tools.google.com/dlpage/gaoptout</span>. you can opt out of Google 
