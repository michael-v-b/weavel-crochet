...
return<>
    ...
    <div>
        ...
        interactions with us and the Services, the choices you make, and the products and features you use. The personal information 
    ...
    <div>
        ...
        stored by Papal. you may find their privacy notice link here: 
        <span className = "link">https://www.paypal.com/us/legalhub/paypal/privacy-ful#paypal_privacy_statement.</span>
    </div>
