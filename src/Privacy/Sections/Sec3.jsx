...
const Sec3 = forwardRef(({ sectionRefs }, ref) => {
  return (
    <>
      <h2 ref={ref}>
      ...
      <div>
        ...
        when we believe it is necessary and we have valid legal reason (i.e.,
        legal basis) to do so under applicable law, like with your content, to
      ...
      <ul>
        <li>
          ...
          <span
            ...
            onClick={() => {
              sectionRefs[10].current.scrollIntoView({
                behavior: "smooth",
              });
            }}
          >
        ...
        <li>
          <strong>Legal Obligations.</strong> We may process your personal
